...
const projects = () => {
  return (
    <>
      <Head>
        <title> Hasan | Projects Page</title>
        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Sacalon Programming Language"
                link=""
                type="Project"
                github="https://github.com/sacalon/sacalon"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/eitaapykit"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/elegraph"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/sourcefa"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Rust-Wheathering"
                link=""
                type="Project"
                github="https://github.com/bistcuite/rust-weathering"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/unox-os"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/spam-detector"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/mobile-price-classification"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Driving Signs Recognition"
                link=""
                type="Project"
                github="https://github.com/bistcuite/iranian-traffic-sign-prediction"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                link=""
                type="Project"
                github="https://github.com/bistcuite/chatbot-deeplearning"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Titanic Survive Prediction"
                link=""
                type="Project"
                github="https://github.com/bistcuite/titanic"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
              <Project
                title="Play Dino Chrome with your hands"
                link=""
                type="Project"
                github="https://github.com/bistcuite/DinoHandGame"
              />
            </div>
            {/* <div className="col-span-6 sm:col-span-12">
              <Project

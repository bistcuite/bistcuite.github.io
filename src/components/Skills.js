    ...
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark
       ...
       sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
        ...
        <Skill name="Django" x="-21vw" y="2vw" />
        <Skill name="HTML" x="-30vw" y="4vw" />
        <Skill name="Python" x="-6vw" y="-9vw" />
        <Skill name="JavaScript" x="19vw" y="6vw" />
        <Skill name="Git" x="0vw" y="10vw" />
        <Skill name="Fastapi" x="-21vw" y="-15vw" />
        <Skill name="Vue.js" x="19vw" y="-12vw" />
        <Skill name="Scikit-learn" x="20vw" y="-5vw" />
        <Skill name="Python" x="19vw" y="-20vw" />
        <Skill name="Bootstrap" x="0vw" y="-20vw" />
        <Skill name="Tensorflow" x="-18vw" y="15vw" />
        <Skill name="Mysql/MongoDB" x="17vw" y="17vw" />
      </div>
    </>
  );
};
